                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="/addNews" method="post"  >
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input name="title" class="form-control col-md-7 col-xs-12" placeholder="" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
